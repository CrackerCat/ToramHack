...
namespace strutil {
     ...
     */
    static inline bool
    replace_first(std::string &str, const std::string &target, const std::string &replacement) {
     ...
     */
    static inline bool
    replace_last(std::string &str, const std::string &target, const std::string &replacement) {
     ...
     */
    static inline bool
    replace_all(std::string &str, const std::string &target, const std::string &replacement) {
        if (target.empty()) {
            return false;
        }
    ...
    regex_split(const std::string &src, const std::string &rgx_str) {
    ...
    regex_split_map(const std::string &src, const std::string &rgx_str) {
     ...
     */
    static inline std::vector<std::string>
    split_any(const std::string &str, const std::string &delims) {
        std::string token;
        std::vector<std::string> tokens;
