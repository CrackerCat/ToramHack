...
inline void HOOK(PTR_T ptr, NEW_T newMethod, T_OLD &oldBytes) {
    if (((void *) ptr) != nullptr)
        shadowhook_hook_func_addr((void *) ptr, (void *) newMethod, (void **) &oldBytes);
}
...
#define BNM_dlopen shadowhook_dlopen
#define BNM_dlsym shadowhook_dlsym
#define BNM_dlclose shadowhook_dlclose
