...
bool CheckHandle(void *handle) {
    ...
    if (Internal::lateInitAllowed)
        Internal::LateInit(
                BNM_dlsym(handle, OBFUSCATE_BNM(BNM_IL2CPP_API_il2cpp_class_from_il2cpp_type)));
...
bool Loading::TryLoadByJNI(JNIEnv *env, jobject context) {
    ...
    auto jDir = (jstring) env->GetObjectField(applicationInfo, env->GetFieldID(applicationInfoClass,
    ...
    auto handle = BNM_dlopen(file.c_str());
    ...
    file = std::string(cDir).substr(0, cDir.length() - 8) +
           OBFUSCATE_BNM("split_config." CURRENT_ARCH ".apk!/lib/" CURRENT_ARCH "/libil2cpp.so");
    handle = BNM_dlopen(file.c_str());
...
bool Loading::TryLoadByUsersFinder() {
    ...
    auto init = Internal::usersFinderMethod(OBFUSCATE_BNM(BNM_IL2CPP_API_il2cpp_init),
                                            Internal::usersFinderMethodData);
    if (!init) return false;

    ::HOOK(init, Internal::BNM_il2cpp_init, Internal::old_BNM_il2cpp_init);

    if (Internal::lateInitAllowed)
        Internal::LateInit(Internal::usersFinderMethod(
                OBFUSCATE_BNM(BNM_IL2CPP_API_il2cpp_class_from_il2cpp_type),
                Internal::usersFinderMethodData));
...
#error "BNM поддерживает только arm64, arm, x86 и x86_64"
    ...
    bool DecodeBranchOrCall(const std::string &hex, BNM_PTR offset, BNM_PTR &outOffset) {
        ...
        outOffset = ((int32_t) (
                ((((HexStr2Value(ReverseHexString(hex))) & (((uint32_t) 1 << 24) - 1) << 0) >> 0)
                        << 2) << (32 - 26)) >> (32 - 26)) + offset + add;
#elif defined(__i386__) || defined(__x86_64__)
...
void Internal::LateInit(void *il2cpp_class_from_il2cpp_type_addr) {
    ...
    Internal::BNM_il2cpp_class_from_system_type_origin = ::HOOK(from_il2cpp_type,
                                                                Internal::BNM_il2cpp_class_from_system_type,
                                                                Internal::old_BNM_il2cpp_class_from_system_type);
}
...
void Internal::SetupBNM() {
    ...
    // il2cpp::vm::Class::Init
    Class$$Init = (decltype(Class$$Init)) AssemblerUtils::FindNextJump(AssemblerUtils::FindNextJump(
            (BNM_PTR) BNM_dlsym(il2cppLibraryHandle, OBFUSCATE_BNM("il2cpp_array_new_specific")),
            count), count);
    BNM_LOG_DEBUG("[SetupBNM] il2cpp::vm::Class::Init в библиотеке: %p.",
                  OffsetInLib((void *) Class$$Init));
...
#undef INIT_IL2CPP_API
    ...
    if (il2cppMethods.il2cpp_image_get_class == nullptr) {
        auto assemblyClass = il2cppMethods.il2cpp_class_from_name(il2cppMethods.il2cpp_get_corlib(),
                                                                  OBFUSCATE_BNM(
                                                                          "System.Reflection"),
                                                                  OBFUSCATE_BNM("Assembly"));
        BNM_PTR GetTypesAdr = Class(assemblyClass).GetMethod(OBFUSCATE_BNM("GetTypes"),
                                                             1).GetOffset();
        ...
        // il2cpp::vm::Image::GetTypes
        orig_Image$$GetTypes = (decltype(orig_Image$$GetTypes)) AssemblerUtils::FindNextJump(
                AssemblerUtils::FindNextJump(AssemblerUtils::FindNextJump(GetTypesAdr, count),
                                             sCount), count);

        BNM_LOG_DEBUG("[SetupBNM] il2cpp::vm::Image::GetTypes в библиотеке: %p.",
                      OffsetInLib((void *) orig_Image$$GetTypes));
    } else
    ...
    // il2cpp::vm::Class::FromIl2CppType
    auto from_type_adr = AssemblerUtils::FindNextJump(
            (BNM_PTR) BNM_dlsym(il2cppLibraryHandle, OBFUSCATE_BNM("il2cpp_class_from_type")),
            count);
    ::HOOK(from_type_adr, ClassesManagement::Class$$FromIl2CppType,
           ClassesManagement::old_Class$$FromIl2CppType);
    BNM_LOG_DEBUG("[SetupBNM] il2cpp::vm::Class::FromIl2CppType в библиотеке: %p.",
    ...
    // il2cpp::vm::Type::GetClassOrElementClass
    auto type_get_class_adr = AssemblerUtils::FindNextJump((BNM_PTR) BNM_dlsym(il2cppLibraryHandle,
                                                                               OBFUSCATE_BNM(
                                                                                       "il2cpp_type_get_class_or_element_class")),
                                                           count);
    ::HOOK(type_get_class_adr, ClassesManagement::Type$$GetClassOrElementClass,
           ClassesManagement::old_Type$$GetClassOrElementClass);
    BNM_LOG_DEBUG("[SetupBNM] il2cpp::vm::Type::GetClassOrElementClass в библиотеке: %p.",
    ...
    auto from_name_adr = AssemblerUtils::FindNextJump(
            AssemblerUtils::FindNextJump((BNM_PTR) il2cppMethods.il2cpp_class_from_name, count),
            count);
    ::HOOK(from_name_adr, ClassesManagement::Class$$FromName,
           ClassesManagement::old_Class$$FromName);
    BNM_LOG_DEBUG("[SetupBNM] il2cpp::vm::Image::FromName в библиотеке: %p.",
    ...
    Assembly$$GetAllAssemblies = (std::vector<IL2CPP::Il2CppAssembly *> *(*)()) (AssemblerUtils::FindNextJump(
            adr, count));
    BNM_LOG_DEBUG(
            "[SetupBNM] il2cpp::vm::Assembly::GetAllAssemblies через domain в библиотеке: %p.",
            OffsetInLib((void *) Assembly$$GetAllAssemblies));
    ...
    if (!vmData.RuntimeMethodInfo$$MakeGenericMethod_impl)
        vmData.RuntimeMethodInfo$$MakeGenericMethod_impl = Class(OBFUSCATE_BNM("System.Reflection"),
                                                                 OBFUSCATE_BNM("MonoMethod"),
                                                                 mscorlib).GetMethod(
    ...
    auto interlockedClass = Class(OBFUSCATE_BNM("System.Threading"), OBFUSCATE_BNM("Interlocked"),
                                  mscorlib);
    ...
    vmData.UnityEngine$$Object = Class(OBFUSCATE_BNM("UnityEngine"), OBFUSCATE_BNM("Object"),
                                       UnityEngineCoreModule);
    vmData.Type$$GetType = Class(OBFUSCATE_BNM("System"), OBFUSCATE_BNM("Type"),
                                 mscorlib).GetMethod(OBFUSCATE_BNM("GetType"), 1);
    vmData.Interlocked$$CompareExchange = interlockedClass.GetMethod(
            OBFUSCATE_BNM("CompareExchange"), {objectClass, objectClass, objectClass});
    vmData.RuntimeType$$MakeGenericType = runtimeTypeClass.GetMethod(
            OBFUSCATE_BNM("MakeGenericType"), 2);
    vmData.RuntimeType$$MakePointerType = runtimeTypeClass.GetMethod(
            OBFUSCATE_BNM("MakePointerType"), 1);
    vmData.RuntimeType$$make_byref_type = runtimeTypeClass.GetMethod(
            OBFUSCATE_BNM("make_byref_type"), 0);
    vmData.String$$Empty = stringClass.GetField(
            OBFUSCATE_BNM("Empty")).cast<Structures::Mono::String *>().GetPointer();
